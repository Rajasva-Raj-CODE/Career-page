        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex items-center min-h-screen">
          <div className="text-center text-foreground w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="group bg-card rounded-2xl p-8 border border-border hover:border-foreground transition-all duration-500 ">
              ...
              <div className="group bg-card rounded-2xl p-8 border border-border hover:border-foreground transition-all duration-500 ">
                ...
                <div className="text-muted-foreground font-medium">Rating</div>
              </div>
            </div>
          </div>
        </div>
