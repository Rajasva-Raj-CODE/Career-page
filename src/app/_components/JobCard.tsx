...
import { MapPin, Calendar, Users, IndianRupee, Share2 } from "lucide-react";
  ...
  return (
    <Card className="group h-auto bg-card border-border shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] hover:border-foreground">
      ...
      <CardFooter className="pt-0 flex gap-2">
        <Button
          onClick={() => onApply(job)}
          className="flex-1 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold transition-all duration-300 hover:scale-[1.02] shadow-lg hover:shadow-xl"
        >
          Apply Now
        </Button>
