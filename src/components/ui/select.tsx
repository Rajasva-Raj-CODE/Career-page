...
function SelectTrigger({
  ...
  size = "md",
  children,
  "aria-invalid": ariaInvalid, // ✅ explicitly handle aria-invalid
  ...props
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      aria-invalid={ariaInvalid} // ✅ required for red ring/border
      className={cn(
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "p-1",
            position === "popper" &&
              "h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)] hover:bg-card scroll-my-1"
          )}
        >
          {children}
        </SelectPrimitive.Viewport>
